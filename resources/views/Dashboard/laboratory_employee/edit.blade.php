...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <a class="d-none d-sm-inline-block h3 mb-0 text-gray-800 text-decoration-none"
                href="{{ route('laboratory_employee.index') }}">
                {{trans('Dashboard/main-sidebar_trans.laboratory')}}
            </a>
            <span class="h5 text-muted mt-1 tx-13 mr-2 mb-0">
                / {{trans('Dashboard\laboratory.edit_employee')}} / <span class="h6">
                    {{$laboratory_employee->name}}</span>
            </span>
        </h1>
    </div>
    @endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('laboratory_employee.update', 'test') }}" method="post" autocomplete="off"
                        class="needs-validation" novalidate>
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        <input class="form-control" value="{{$laboratory_employee->id}}" name="id" type="hidden">
                        <div class="container-fluid">
                            <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $laboratory_employee->name }}" id="name" type="text" name="name"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $laboratory_employee->email }}" id="email" type="email"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $laboratory_employee->phone }}" id="phone" type="number"
                            ...
                            <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $laboratory_employee->job_title }}" id="job_title" type="text"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $laboratory_employee->job_number }}" id="job_num" type="text"
                            ...
                            <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea id="description" rows="5" name="description" class="form-control"
                                        required>{{ $laboratory_employee->description }}</textarea>
                                    <div class="valid-feedback">
                                        {{ trans('validation.good')}}
                                    </div>
                                    <div class="invalid-feedback">
