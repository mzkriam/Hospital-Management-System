...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route('Doctors.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        ...
                                        <a class="dropdown-item" href="{{ route('doctor.showOperation',$doctor->id)}}">
                                            <i style="color: rgb(81, 223, 135)" class="fas fa-medkit"></i>&nbsp;&nbsp;
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('admin_doc_appointment', $doctor->id) }}">
