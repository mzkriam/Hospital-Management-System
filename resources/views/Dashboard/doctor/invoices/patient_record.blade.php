                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning"
                                        href="{{route('invoices.show',$patient_ray->id)}}">
                                ...
                                <td>
                                    <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"
                                        data-toggle="modal" href="#edit_xray_conversion{{$patient_ray->id}}">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                        data-toggle="modal" href="#delete{{$patient_ray->id}}">
                    ...
                    <table class="table table-hover text-md-nowrap text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning"
                                        href="{{route('showLaboratory',$patient_Laboratorie->id)}}">
                                        <i class="fas fa-binoculars"></i>
                                    </a>
                                </td>
                                @endif
                                ...
                                <td>
                                    <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"
                                        data-toggle="modal"
                                        href="#edit_laboratorie_conversion{{$patient_Laboratorie->id}}">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                        data-toggle="modal" href="#deleted_laboratorie{{$patient_Laboratorie->id}}">
