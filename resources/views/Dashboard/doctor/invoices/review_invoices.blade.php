                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>{{trans("Dashboard/invoices.date_medical_review")}}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                \App\Models\Treatment::where(['invoice_id' =>$invoice->id])->first()->review_date
                                }}
                            </td>
                            @if(auth('doctor')->check())
                            <td>
