...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('ray_employee.update', 'test') }}" method="post" autocomplete="off"
                        class="needs-validation" novalidate>
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        <input class="form-control" value="{{$ray_employee->id}}" name="id" type="hidden">
                        <div class="container-fluid">
                            <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $ray_employee->name }}" id="name" type="text" name="name"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $ray_employee->email }}" id="email" type="email" name="email"
                                        class="form-control" required>
                                    <div class="valid-feedback">
                                        {{ trans('validation.good')}}
                                    </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $ray_employee->phone }}" id="phone" type="number" name="phone"
                                        class="form-control" required>
                                    <div class="valid-feedback">
                                        {{ trans('validation.good')}}
                                    </div>
                            ...
                            <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $ray_employee->job_title }}" id="job_title" type="text"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input value="{{ $ray_employee->job_number }}" id="job_num" type="text"
                            ...
                            <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea id="description" rows="5" name="description" class="form-control"
                                        required>{{ $ray_employee->description }}</textarea>
                                    <div class="valid-feedback">
                                        {{ trans('validation.good')}}
                                    </div>
                                    <div class="invalid-feedback">
