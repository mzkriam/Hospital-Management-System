    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    @if(auth('admin')->check())
                    <form action="{{ route('admin_Receipt.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <form action="{{ route('Receipt.update', 'test') }}" method="post" autocomplete="off"
                            ...
                            {{ method_field('patch') }}
                            {{ csrf_field() }}
                            <input class="form-control" value="{{$receipt_accounts->id}}" id="id" name="id"
                                type="hidden">
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" type="number" name="invoice_id" value="{{$invoice->id}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" name="patient_id" value="{{$receipt_accounts->patients->id}}">
                                    <input class="form-control" type="text" name="patient_name" id="patient_name"
                                        disabled value="{{$receipt_accounts->patients->name}}">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row row-xs align-items-center my-3 mg-b-20 d-flex flex-row-reverse">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="total_credit" id="total_credit"
                                        disabled
                                        value="{{$account_patients->total_credit - $receipt_accounts->amount}}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center my-3 mg-b-20 d-flex flex-row-reverse">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="text" name="debit" id="debit" disabled
                                        value="{{$account_patients->total_debit - $account_patients->total_credit + $receipt_accounts->amount}}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center MY-3 mg-b-20 d-flex flex-row-reverse">
                                <div class="col-md-4">
                                    ...
                                    <input value="{{$receipt_accounts->amount}}" id="amount" type="number" min="0"
                                        max="{{$account_patients->total_debit - $account_patients->total_credit + $receipt_accounts->amount}}"
