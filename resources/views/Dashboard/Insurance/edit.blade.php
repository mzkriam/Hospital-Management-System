    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    @if(auth('admin')->check())
                    <form action="{{route('adminInsurance.update','test')}}" method="post" autocomplete="off"
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-4">
                                ...
                                <input value="{{ $insurances->insurance_code }}" class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <input value="{{$insurances->name }}" class="form-control" name="name" type="text"
                                    required>
                                <div class="valid-feedback">
                                    {{ trans('validation.good')}}
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input value="{{$insurances->contact_number }}" class="form-control"
                        ...
                        <div class="row row-xs align-items-center my-3 mg-b-20">
                            <div class="col-md-4">
                                <div class="">
                                    <div class="">
                                        ...
                                        <input value="{{$insurances->discount_percentage }}" class="form-control"
                                ...
                                <div class="my-3">
                                    ...
                                    <input value="{{$insurances->company_rate }}" class="form-control"
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea rows="5" id="notes" name="notes"
                                    class="form-control">{{ $insurances->notes }}</textarea>
                            </div>
                        </div>
                    ...
                    @else
                    <form action="{{route('Insurance.update','test')}}" method="post" autocomplete="off"
                        class="needs-validation" novalidate>
                        @method('PUT')
                        @csrf
                        <input type="hidden" name="id" value="{{$insurances->id}}">
