<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('laboratory_employee.dashboard') }}">
    ...
    <li class="nav-item">
        ...
        <div id="collapseSection" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-dark py-2 collapse-inner rounded">
                <a class="collapse-item text-light" href="{{ route('invoices_laboratory_employee.index') }}">
                    {{trans("Dashboard/invoices.list_of_examinations")}}
                </a>
                <a class="collapse-item text-light" href="{{route('completed_invoices_laboratory_employee')}}">
