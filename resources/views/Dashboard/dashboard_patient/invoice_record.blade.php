        ...
        <div class="tab-menu-heading">
            <div class="tabs-menu1">
                <ul class="nav panel-tabs main-nav-line bg-gradient-secondary"
                    ...
                    <li class="nav-item">
                        <a href="#tab8" class="nav-link text-decoration-none text-light" data-toggle="tab">
                            {{trans("Dashboard/invoices.results")}}
                        </a>
                    </li>
                </ul>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning" href="{{route('showRay',$patient_ray->id)}}">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning"
                                        href="{{route('patient.showLaboratory',$patient_Laboratorie->id)}}">
                                        <i class="fas fa-binoculars"></i>
                                    </a>
                                    @endif
                                </td>
            ...
            <div class="tab-pane" id="tab8">
                <div class="table-responsive">
                    <table class="table table-hover text-md-nowrap text-center">
                        <thead>
                            <tr>
                                <th class="col-2">{{trans("Dashboard/ray_service.name")}}</th>
                                <th class="col-2">{{trans("Dashboard/invoices.invoice_number")}}</th>
                                <th class="col-6">{{trans('Dashboard/invoices.type')}}</th>
                                <th class="col-2">{{trans('Dashboard/invoices.total_with_tax')}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="col-2">{{$Invoice->id}}</td>
                                <td class="col-6">{{ $Invoice->type == 1 ?
                                    trans('Dashboard/invoices.cash'):trans('Dashboard/invoices.credit')
                                    }}
                                </td>
                                <td class="col-2">{{number_format($Invoice->total_with_tax)}}</td>
                            </tr>
                        </tbody>
                        @foreach($patient_operations as $patient_operation)
                        <tr>
                            <td class="col-2">{{trans("Dashboard/invoices.operations")}} : </td>
                            <td class="col-2">{{$patient_operation->invoice_id}}</td>
                            <td class="col-6">{{$patient_operation->name}}</td>
                            <td class="col-2">{{$patient_operation->price}}</td>
                        </tr>
                        @endforeach
                        @foreach($patient_rays as $patient_ray)
                        <tr>
                            <td class="col-2">{{trans("Dashboard/invoices.X-rays")}} :</td>
                            <td class="col-2">{{$patient_ray->invoice_id}}</td>
                            <td class="col-6">{{$patient_ray->name}}</td>
                            <td class="col-2">{{$patient_ray->price}}</td>
                        </tr>
                        @endforeach
                        @foreach($patient_Laboratories as $patient_Laboratorie)
                        <tr>
                            <td class="col-2">{{trans("Dashboard/invoices.Laboratory")}} : </td>
                            <td class="col-2">{{$patient_Laboratorie->invoice_id}}</td>
                            <td class="col-6">{{$patient_Laboratorie->name}}</td>
                            <td class="col-2">{{$patient_Laboratorie->price}}</td>
                        </tr>
                        @endforeach
                        @foreach($Invoice->Medicines as $patient_medicine)
                        <tr>
                            <td class="col-2">{{trans("Dashboard/medicine.medicine")}} : </td>
                            <td class="col-2">{{$Invoice->id}}</td>
                            <td class="col-6">{{$patient_medicine->name}}</td>
                            <td class="col-2">{{$patient_medicine->price}}</td>
                        </tr>
                        @endforeach
                        </tbody>
                    </table>
                    <table class="table table-hover text-md-nowrap text-center">
                        ...
                        <tbody>
                            <tr>
                                <td class="col-2"></td>
                                <td class="col-2"></td>
                                <td class="col-6">{{trans('Dashboard/invoices.total_with_tax')}}</td>
                                <td class="col-2">{{number_format($total_invoice, 2)}}</td>
                            </tr>
                            @if($Invoice->type == 1)
                            <tr>
                                <td class="col-2"></td>
                                <td class="col-2"></td>
                                <td class="col-6">{{trans('Dashboard/invoices.total_credit')}}</td>
                                <td class="col-2">{{number_format($Invoice->total_with_tax, 2)}}</td>
                            </tr>
                            <tr>
                                <td class="col-2"></td>
                                <td class="col-2"></td>
                                <td class="col-6">{{trans('Dashboard/invoices.total_debit')}}</td>
                                <td class="col-2">{{number_format($total_invoice - $Invoice->total_with_tax, 2)}}
                                </td>
                            </tr>
                            @endif
                        </tbody>
                    ...
                    <table class="table table-hover text-md-nowrap text-center">
                        <thead>
                            <tr>
                                <th class="col-2">#</th>
                                <th class="col-2">{{trans("Dashboard/invoices.invoice_number")}}</th>
                                <th class="col-6">{{trans("Dashboard/invoices.receipt_number")}}</th>
                                <th class="col-2">{{trans("Dashboard/ray_service.price")}}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($receipts as $receipt)
                            <tr>
                                ...
                                <td class="col-2">{{$receipt->invoice_id}}</td>
                                <td class="col-6">{{$receipt->id}}</td>
                                <td class="col-2">{{number_format($receipt->amount, 2)}}</td>
                            </tr>
                            @endforeach
                            @if($account_patients)
                            <tr>
                                ...
                                <td class="col-2"></td>
                                <td class="col-6">{{trans('Dashboard/invoices.total_credit')}}</td>
                                <td class="col-2">{{number_format($account_patients->total_credit, 2)}}</td>
                            </tr>
                            @endif
                            <tr>
                                <td class="col-2"></td>
                                ...
                                <td class="col-2">
                                    @if($account_patients)
                                    {{number_format($total_invoice - $Invoice->total_with_tax -
                                    $account_patients->total_credit, 2)}}
                                    @else
                                    {{number_format($total_invoice - $Invoice->total_with_tax, 2)}}
                                    @endif
                                </td>
                                @endif
                                @if($Invoice->type == 2)
                                @if($account_patients)
                                <td class="col-2">{{number_format($total_invoice - $account_patients->total_credit,2)}}
                                </td>
                                @else
                                <td class="col-2">{{number_format($total_invoice,2)}}</td>
                                @endif
