...
@section('title')
{{trans('Dashboard/operations.edit_treatment')}}
@endsection
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            ...
            <span class="h5 text-muted mt-1 tx-13 mr-2 mb-0">
                / {{trans('Dashboard/operations.edit_treatment')}} / <span class="h6">
                    {{$treatment->name}}</span>
            </span>
        </h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('treatment.update', 'test') }}" method="post" autocomplete="off"
                        class="needs-validation" novalidate>
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        <input class="form-control" value="{{$treatment->id}}" name="id" type="hidden">
                        <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                            <div class="col-md-4 mb-2">
                                ...
                                <input value="{{$treatment->name }}" id="name" type="text" name="name"
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input required value='{{$treatment->price }}' id="price" type="number" name="price"
                            ...
                            <div class="col-md-4">
                                ...
                                <select required name="section_id" class="form-select">
                                    ...
                                    <option value="{{$section->id}}" {{$section->id == $treatment->section_id ?
                                        'selected'
                                        : "" }}>
                                        {{$section->name}}</option>
                                    @endforeach
                        ...
                        <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                            <div class="col-md-4">
                                ...
                                <select multiple class="form-control" id="doctors" name="doctors[]">
                                    ...
                                    <option value="{{ $doctor->id }}" {{ in_array($doctor->id,
                                        $treatment->doctors->pluck('id')->toArray()) ? 'selected'
                                        : '' }}>{{ $doctor->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select multiple class="form-control" id="medicines" name="medicines[]">
                                    ...
                                    <option value="{{ $medicine->id }}" {{ in_array($medicine->id,
                                        $treatment->medicines->pluck('id')->toArray()) ?
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea id="description" rows="4" name="description" class="form-control" required
                                    type="text" price>{{ $treatment->description }}</textarea>
                                <div class="valid-feedback">
                                    {{ trans('validation.good')}}
                                </div>
                                <div class="invalid-feedback">
                        ...
                        <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                            <div class="col-md-3 mb-2">
                                ...
                                <textarea class="form-control" type="text" name="procedures" id="procedures"
                                    rows="5">{{$treatment->procedures }}</textarea>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <textarea id="warnings" type="text" name="warnings" class="form-control"
                                    rows="5">{{$treatment->warnings }}</textarea>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <textarea id="side_effects" type="text" name="side_effects" class="form-control"
                                    rows="5">{{$treatment->side_effects }}</textarea>
                            </div>
                            <div class="col-md-3 mb-2">
                                ...
                                <textarea id="results" type="text" name="results" rows="5"
                                    class="form-control">{{$treatment->results }}</textarea>
                            </div>
                        </div>
