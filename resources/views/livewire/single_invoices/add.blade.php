                ...
                <form wire:submit.prevent="store" autocomplete="off">
                    ...
                    <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-3">
                            ...
                            <input wire:model="doctor_name" type="text" class="form-control" readonly>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col">
                            ...
                            <select wire:model="type" class="form-control" {{$updateMode==true ? "disabled" : "" }}>
                                <option value="" selected>{{trans('Dashboard/invoices.choose_from_the_list') }}</option>
                                        ...
                                        <table class="table table-striped mg-b-0 text-md-nowrap"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input wire:model="discount_value" type="text"
                                                            class="form-control">
                                                    </td>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control" value="{{$tax_value}}"
                                                            readonly>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control" readonly
                                                            value="{{$subtotal + $tax_value }}">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
