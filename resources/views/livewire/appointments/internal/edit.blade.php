            ...
            <div class="card-body">
                <form wire:submit.prevent="update" autocomplete="off">
                    ...
                    {{-- <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                        ...
                        <div class="col-md-4">
                            <label class="form-label" for="birth_patient">{{trans('Dashboard\patients.date')}}</label>
                            <input wire:model="birth_patient" class="form-control fc-datepicker" name="birth_patient"
                                placeholder="YYYY-MM-DD" type="text" required value="{{old('birth_patient')}}">
                            <div class="valid-feedback">
                                {{ trans('validation.good')}}
                            </div>
                            <div class="invalid-feedback">
                    ...
                    <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                        ...
                        <div class="col-md-4">
                            ...
                            <input wire:model="appointment_patient" class="form-control" name="appointment_patient"
                                id="datetimepicker" type="text" placeholder="{{ now() }}" value="{{ now() }}" disabled>
                        </div>
                    </div>
                    <div class="row row-xs align-items-center my-4 mg-b-20 d-flex align-items-stretch">
                        <div class="col-md-12">
                            ...
                            <textarea wire:model="notes" id="notes" rows="4" name="notes" class="form-control" required
                                type="text">{{ old('notes') }}</textarea>
                            <div class="valid-feedback">
                                {{ trans('validation.good')}}
                            </div>
