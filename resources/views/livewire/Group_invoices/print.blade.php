                            ...
                            <div class="card-body">
                                <div class="invoice-header">
                                    <h1 class="invoice-title">
                                        {{trans('Dashboard/main-sidebar_trans.group_invoices')}}</h1>
                                    <div class="billed-from">
                                        <h6>{{trans('Dashboard/main-sidebar_trans.group_invoices')}}</h6>
                                        <p>201 المهندسين<br>
                                ...
                                <div class="row mg-t-20">
                                    <div class="col-md">
                                        ...
                                        <p class="invoice-info-row">
                                            ...
                                            <span>{{Request::get('Group_id')}}</span>
                                        </p>
                                        <p class="invoice-info-row">
                                        ...
                                        <p class="invoice-info-row">
                                            <span>{{trans('Dashboard/receipt.date')}} : </span>
                                            <span>{{ Request::get('invoice_date') }}</span>
                                        </p>
                                        <p class="invoice-info-row">
                                            <span>{{trans('Dashboard/print.doctor')}} : </span>
                                            <span>{{Request::get('doctor_id')}}</span>
                                        </p>
                                        <p class="invoice-info-row">
                                            <span>{{trans('Dashboard/print.section')}} : </span>
                                    ...
                                    <table class="table table-invoice border text-md-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="tx-right">{{Request::get('type') == 1 ?
                                            ...
                                            <tr>
                                                ...
                                                <td class="tx-right" colspan="2">
                                                    <h4 class="tx-primary tx-bold">
                                                        {{number_format(Request::get('total_with_tax'),
                                                        2)}}</h4>
                                                </td>
                                            </tr>
                                        </tbody>
