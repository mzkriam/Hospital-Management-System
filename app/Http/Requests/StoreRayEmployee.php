...
class StoreRayEmployee extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "email" => 'required|email|unique:ray_employees,email,' . $this->id,
            'password' => [
                'sometimes',
                'required',
                'string',
            ...
            "phone" => 'required|numeric|regex:/^([0-9\s\-\+\(\)]*)$/|min:10|unique:ray_employees,phone,' . $this->id,
        ];
    }
