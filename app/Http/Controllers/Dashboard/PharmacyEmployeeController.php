...
use App\Http\Requests\StorePharmacyEmployee;
use Illuminate\Http\Request;

class PharmacyEmployeeController extends Controller
{
    private $employee;
    public function __construct(PharmacyEmployeeRepositoryInterface $employee)
    {
    ...
    public function store(StorePharmacyEmployee $request)
    {
    ...
    public function update(StorePharmacyEmployee $request)
    {
